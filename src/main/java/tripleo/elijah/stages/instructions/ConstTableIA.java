...
public class ConstTableIA implements InstructionArgument {
    ...
    public String toString() {
        ...
        if (name != null) return String.format("(ct %d) [%s=%s]", index, name, constantTableEntry.initialValue);
        else return String.format("(ct %d) [%s]", index, constantTableEntry.initialValue);
    }
