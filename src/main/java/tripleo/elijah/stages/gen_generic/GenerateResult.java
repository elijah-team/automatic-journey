...
public class GenerateResult {
    ...
    public void addConstructor(
            final GeneratedConstructor aGeneratedConstructor,
    ...
    public void addNamespace(
            final TY ty, final GeneratedNamespace aNamespace, final Buffer aBuf, final LibraryStatementPart aLsp) {
