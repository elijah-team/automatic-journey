...
public interface PostBC_Processor {
    @Contract("_, _, _ -> new")
    static @NotNull PostBC_Processor make_VTE(
            @NotNull final VariableTableEntry aVariableTableEntry,
            final Context aFd_ctx,
            final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
    ...
    abstract class __PostBC_Processor__VTE implements PostBC_Processor {
        private static DeduceType3 doNoTypeAttached__zero_potential(
                final @NotNull VariableTableEntry vte, final Supplier<CantDecideType> cdt) {
        ...
        private static @NotNull DeduceType3 doNoTypeAttached__single_potential(
                final VariableTableEntry vte, final DeduceTypes2.@NotNull DeduceClient1 deduceTypes2) {
            final OS_Type attached =
                    deduceTypes2.getPotentialTypesVte(vte).get(0).getAttached();
        ...
        private @NotNull DeduceType3 doNoTypeAttached__numerous_potential(
                final @NotNull IDeduceElement3 de3,
        ...
        private Promise<DeduceType3, Diagnostic, Void> postBC_getTypeFor_VTE(
            ...
            if (vte_type_attached == null) {
                final DeduceType3 r2 =
                        vte.getPostBC_Processor(fd_ctx, deduceClient1).doNoTypeAttached(errSink);
                rr.resolve(r2);
            } else {
                final Maybe<OS_Type> r1 =
                        vte.getPostBC_Processor(fd_ctx, deduceClient1).doHasTypeAttached();
                if (r1.exc != null) {
                    rr.reject(r1.exc);
                } else {
    ...
    class PostBC_Processor__VTE_SELF extends PostBC_Processor.__PostBC_Processor__VTE {
        ...
        public PostBC_Processor__VTE_SELF(
                final VariableTableEntry aVariableTableEntry,
                final Context aFd_ctx,
                final OS_Type aVte_type_attached,
                final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
         ...
         * aPost_byteCode, final ErrSink aErrSink1) { DED dt3 = new DED() { public DED
         * elementDiscriminator() { return null; }
         *
         * public DeduceTypes2 deduceTypes2() { return null; }
         *
         * public GeneratedFunction generatedFunction() { return null; }
         *
         * public GenType genType() { return null; }
         *
         * @Override public Kind kind() { return null; } };
         *
         * return new DeduceType3((IDeduceElement3) dt3,
    ...
    class PostBC_Processor__VTE_RESULT extends PostBC_Processor.__PostBC_Processor__VTE {
        ...
        public PostBC_Processor__VTE_RESULT(
                final VariableTableEntry aVariableTableEntry,
                final Context aFd_ctx,
                final OS_Type aVte_type_attached,
                final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
    ...
    class PostBC_Processor__VTE_ARG extends PostBC_Processor.__PostBC_Processor__VTE {
        ...
        public PostBC_Processor__VTE_ARG(
                final VariableTableEntry aVariableTableEntry,
                final Context aFd_ctx,
                final OS_Type aVte_type_attached,
                final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
    ...
    class PostBC_Processor__VTE_VAR extends PostBC_Processor.__PostBC_Processor__VTE {
        ...
        public PostBC_Processor__VTE_VAR(
                final VariableTableEntry aVariableTableEntry,
                final Context aFd_ctx,
                final OS_Type aVte_type_attached,
                final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
    ...
    class PostBC_Processor__VTE_TEMP extends PostBC_Processor.__PostBC_Processor__VTE {
        ...
        public PostBC_Processor__VTE_TEMP(
                final VariableTableEntry aVariableTableEntry,
                final Context aFd_ctx,
                final OS_Type aVte_type_attached,
                final DeduceTypes2.DeduceClient1 aDeduceTypes2) {
