...
public class DeduceElement3_ProcTableEntry implements IDeduceElement3 {
    ...
    public DeduceElement3_ProcTableEntry(
                    ...
                    if (dotleft.getLeft() instanceof final IdentExpression rl
                        ...
                        if (rl.getText().equals("a1")) {
                            ...
                            vte.typePromise().then(left_type -> {
                                final ClassStatement cs =
                                        left_type.getResolved().getClassOf(); // TODO we want a DeduceClass
                                ...
                                if (best != null) {
                                    ...
                                    final FunctionInvocation fi2 = new FunctionInvocation(
                                            fun, null, ci, deduceTypes2._phase().getGeneratePhase()); // TODO pte??
                                    ...
                                    final @NotNull IdentTableEntry ite =
                                            ((IdentIA) principal.expression_num).getEntry();
        ...
        if (_backlink instanceof final @NotNull ProcIA backlink_) {
            ...
            backlink.onResolvedElement((DT_Element3 dtel) -> {
                ...
                try {
                    ...
                    assert !(resolvedElement instanceof OS_Element2 named) || ident.sameName(named);
