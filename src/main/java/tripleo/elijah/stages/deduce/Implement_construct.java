...
class Implement_construct {
                    ...
                    if (el2 == null) {
                        ...
                        if (idte2.type == null) {
                            ...
                            final TypeTableEntry tte =
                                    generatedFunction.newTypeTableEntry(TypeTableEntry.Type.TRANSIENT, ty);
                            try {
                        ...
                        if (i + 1 == deducePath.size()) {
                            ...
                            if (el2 instanceof ConstructorDef) {
                                ...
                                if (type.getNonGenericTypeName() == null) {
                                    type.setNonGenericTypeName(
                                            deducePath.getType(i - 1).getNonGenericTypeName()); // HACK. not
                                    // guararnteed
                                    // to work!
                                }
    ...
    private void implement_construct_type(
            @Nullable final Constructable co, @Nullable final OS_Type aTy, final String constructorName) {
        assert aTy != null;
    ...
    private void _implement_construct_type(
            @Nullable final Constructable co,
            @Nullable final String constructorName,
