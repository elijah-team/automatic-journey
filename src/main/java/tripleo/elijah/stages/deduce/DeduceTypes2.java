...
public class DeduceTypes2 {
    ...
    public DeduceTypes2(
            @NotNull final OS_Module module, @NotNull final DeducePhase phase, final ElLog.Verbosity verbosity) {
        this.module = module;
        this.phase = phase;
    ...
    public static int to_int(@NotNull final InstructionArgument arg) {
        if (arg instanceof IntegerIA) return ((IntegerIA) arg).getIndex();
        if (arg instanceof ProcIA) return ((ProcIA) arg).getIndex();
        if (arg instanceof IdentIA) return ((IdentIA) arg).getIndex();
    ...
    <T> int df_helper(@NotNull final List<GeneratedNode> aGeneratedClasses, @NotNull final df_helper_i<T> dfhi) {
        ...
        for (final GeneratedNode generatedNode : aGeneratedClasses) {
            ...
            for (final T generatedConstructor : lgf2) {
                if (dfh.deduce(generatedConstructor)) size++;
            }
        }
        return size;
    }
                        ...
                        public void onChange(final IElementHolder eh, final BaseTableEntry.Status newStatus) {
                            ...
                            switch (type) {
                                ...
                                case FUNCTION:
                                    ...
                                    if (pte.expression_num instanceof IdentIA) identIA2 = (IdentIA) pte.expression_num;
                                    if (identIA2 != null) {
                                        ...
                                        if (procTableEntry != null) {
                                            ...
                                            procTableEntry.onFunctionInvocation(new DoneCallback<FunctionInvocation>() {
                                                ...
                                                public void onDone(
                                                    ...
                                                    @NotNull
                                                    final FunctionInvocation fi = newFunctionInvocation(
    ...
    private GenType makeGenTypeFromOSType(final OS_Type aType, final @Nullable Map<TypeName, OS_Type> aGenericPart) {
        ...
        } else throw new AssertionError("Not a USER Type");
        return gt;
    }
    ...
    public ClassInvocation genCI(@NotNull final GenType genType, final TypeName aGenericTypeName) {
        ...
        if (genType.getResolved() != null) {
            ...
            if (genType.getCi() == null) {
                ...
                clsinv = phase.registerClassInvocation(clsinv);
                genType.setCi(clsinv);
            } else clsinv = (ClassInvocation) genType.getCi();
            return clsinv;
        }
        return null;
    }
            ...
            case USER: {
                ...
                switch (tn1.kindOfType()) {
                    case NORMAL: {
                        ...
                        } else R.setResolved(new OS_UserClassType((ClassStatement) best));
                        break;
                    }
                    case FUNCTION:
                    case GENERIC:
    ...
    public void resolve_ident_table_entry(
        ...
        if (ite.getResolvedElement() != null) return;
        if (true) {
                                ...
                                try {
                                    ...
                                    if (rt.getResolved() != null
                                        ...
                                        if (rt.getResolved()
                                                        ...
                                                        .getGenericPart()
                                                        .size()
                                                > 0) b.setNonGenericTypeName(a.getTypeName()); // TODO might be wrong
                                        dof_uc(vte, rt.getResolved());
                                    }
                                } catch (final ResolveError aResolveError) {
                                    errSink.reportDiagnostic(aResolveError);
    ...
    public void do_assign_normal_ident_deferred_VariableStatement(
        ...
        final IInvocation invocation;
        if (generatedFunction.fi.getClassInvocation() != null) invocation = generatedFunction.fi.getClassInvocation();
        else invocation = generatedFunction.fi.getNamespaceInvocation();
        @NotNull
    ...
    public void resolve_var_table_entry(
        ...
        if (vte.getResolvedElement() == null) return;
        {
                        ...
                        public void onDone(@NotNull final FunctionInvocation result) {
                            result.generateDeferred().done(new DoneCallback<BaseGeneratedFunction>() {
                                ...
                                public void onDone(@NotNull final BaseGeneratedFunction bgf) {
                                    @NotNull
                                    final PromiseExpectation<GenType> pe =
                    ...
                    forFunction(newFunctionInvocation(fd, pte, invocation, phase), new ForFunction() {
                        ...
                        public void typeDecided(final @NotNull GenType aType) {
                            ...
                            if (idte.type == null) {
                                ...
                                // expression?
                                idte.type = tte1;
                            } else idte.type.setAttached(gt(aType));
                        }
                    });
                } else {
                    throw new NotImplementedException();
    ...
    void found_element_for_ite(
        ...
        @NotNull
        final Found_Element_For_ITE fefi =
    ...
    public void resolveIdentIA_(
        ...
        final Resolve_Ident_IA ria = new Resolve_Ident_IA(
                new DeduceClient3(this), context, identIA, generatedFunction, foundElement, errSink);
        try {
            ria.action();
    ...
    public Zero_FuncExprType getZero(final OS_FuncExprType aFuncExprType) {
        if (!(_zeros.containsKey(aFuncExprType))) _zeros.put(aFuncExprType, new Zero_FuncExprType(aFuncExprType));
    ...
    static class ProcessElement {
        static void processElement(final OS_Element el, final IElementProcessor ep) {
            if (el == null) ep.elementIsNull();
            else ep.hasElement(el);
        }
    }
    ...
    public static class DeduceClient3 {
        ...
        public IElementHolder newGenericElementHolderWithType(final OS_Element aElement, final TypeName aTypeName) {
            ...
            if (aTypeName.isNull()) typeName = null;
            else typeName = new OS_UserType(aTypeName);
    ...
    class Lookup_function_on_exit {
        ...
        public void action(@NotNull final ProcTableEntry pte) {
            ...
            if (fi.getFunction() == null) {
                if (fi.pte == null) {
                    ...
                    if (fi.pte.getClassInvocation() != null) fi.setClassInvocation(fi.pte.getClassInvocation());
                    //					else
        ...
        void proceed(
            ...
            if (fd2 == ConstructorDef.defaultVirtualCtor) {
                if (fi.pte.getArgs().size() == 0) state = 1;
                else state = 2;
