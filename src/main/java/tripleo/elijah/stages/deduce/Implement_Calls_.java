...
class Implement_Calls_ {
    ...
    public Implement_Calls_(
            ...
            final @NotNull BaseGeneratedFunction aGf,
    ...
    void action() {
        ...
        if (!found) pte.setStatus(BaseTableEntry.Status.UNKNOWN, null);
    }
    ...
    private boolean action_i2_IntegerIA_vteName_is_null(
            final String pn, @Nullable final String pn2, final Context ctx, final String vteName) {
        boolean found = false;
    ...
    private boolean action_i2_IntegerIA_vteName_is_not_null(
            final String pn, @Nullable final String pn2, @NotNull final VariableTableEntry vte) {
