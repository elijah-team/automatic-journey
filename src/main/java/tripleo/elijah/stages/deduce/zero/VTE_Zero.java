...
public class VTE_Zero {
    ...
    private void vte_pot_size_is_1_USER_TYPE(
    ...
    private void vte_pot_size_is_1_USER_CLASS_TYPE(
            @NotNull final VariableTableEntry vte,
            @Nullable final OS_Type aTy,
            final @NotNull DeduceTypes2 deduceTypes2,
            final IdentTableEntry ite,
            final ErrSink errSink,
            final DeducePhase phase) {
    ...
    public void fp_onChange__001(
            @NotNull final TypeTableEntry tte,
            final IdentTableEntry ite,
            @NotNull final DeduceTypes2 deduceTypes2,
            final @NotNull ErrSink errSink) {
        ...
        try {
            ...
            switch (ty.getType()) {
                case USER:
                    final @NotNull GenType ty2 =
                            deduceTypes2.resolve_type(ty, ty.getTypeName().getContext());
                    ...
                    final OS_Element ele = ty2.getResolved().getElement();
                    final LookupResultList lrl =
                            DeduceLookupUtils.lookupExpression(iteIdent, ele.getContext(), deduceTypes2);
