...
public class DeduceLookupUtils {
    public static LookupResultList lookupExpression(
            final @NotNull IExpression left, final @NotNull Context ctx, final @NotNull DeduceTypes2 deduceTypes2)
            throws ResolveError {
        switch (left.getKind()) {
            case QIDENT:
    ...
    @Nullable
    public static OS_Element _resolveAlias(
            final @NotNull AliasStatement aliasStatement, @NotNull final DeduceTypes2 deduceTypes2) {
        ...
        if (aliasStatement.getExpression() instanceof Qualident) {
            ...
            } else lrl2 = aliasStatement.getContext().lookup(((IdentExpression) de).getText());
    ...
    @Nullable
    public static OS_Element _resolveAlias2(
            final @NotNull AliasStatement aliasStatement, @NotNull final DeduceTypes2 deduceTypes2)
            throws ResolveError {
    ...
    private static LookupResultList lookup_dot_expression(
            Context ctx, final @NotNull DotExpression de, @NotNull final DeduceTypes2 deduceTypes2)
            throws ResolveError {
        ...
        /* ! */ s.size() > 1 /* isEmpty() */) {
            ...
            if (t != null) {
                ...
                if (resolved != null
                        && (resolved.getType() == OS_Type.Type.USER_CLASS
        ...
        if (t == null) {
            ...
            if (t.getResolved() instanceof OS_UnknownType) return new LookupResultList(); // TODO is this right??
            if (t.getResolved() == null) return new LookupResultList(); // TODO is this right?? feb 20
            final LookupResultList lrl = t.getResolved()
    ...
    public static @Nullable GenType deduceExpression(
            @NotNull final DeduceTypes2 aDeduceTypes2, @NotNull final IExpression n, final @NotNull Context context)
            throws ResolveError {
        switch (n.getKind()) {
            case IDENT:
                final Promise<GenType, ResolveError, Void> x =
                        deduceIdentExpression_p(aDeduceTypes2, (IdentExpression) n, context);
            ...
            case DOT_EXP:
                ...
                final @Nullable GenType right_type = deduceExpression(
                        aDeduceTypes2,
                        de.getRight(),
    ...
    public static Promise<GenType, ResolveError, Void> deduceExpression_p(
            @NotNull final DeduceTypes2 aDeduceTypes2, @NotNull final IExpression n, final @NotNull Context context) {
    ...
    private static Promise<@Nullable GenType, ResolveError, Void> deduceProcedureCall_p(
    ...
    private static Promise<@Nullable GenType, ResolveError, Void> deduceIdentExpression_p(
            @NotNull final DeduceTypes2 aDeduceTypes2,
    ...
    static @Nullable OS_Element lookup(
            @NotNull final IExpression expression, @NotNull final Context ctx, @NotNull final DeduceTypes2 deduceTypes2)
            throws ResolveError {
            ...
            try {
                switch (n.getKind()) {
                    ...
                    case DOT_EXP:
                        ...
                        break;
                    case PROCEDURE_CALL:
                        final Promise<GenType, ResolveError, Void> x2 =
                                deduceProcedureCall_p((ProcedureCallExpression) n, context, aDeduceTypes2);
                    ...
                    case QIDENT:
                        final IExpression expression = Helpers.qualidentToDotExpression2(((Qualident) n));
                        @Nullable
                        final Promise<GenType, ResolveError, Void> x3 =
                                deduceExpression_p(aDeduceTypes2, expression, context);
    ...
    static class __deduceProcedureCall_p {
        ...
        public void do_deduceProcedureCall(
                final ProcedureCallExpression pce, final Context ctx, final DeduceTypes2 deduceTypes2) {
            @Nullable final GenType result = new GenType();
    ...
    static class __deduceIdentExpression_p {
        ...
        @Nullable
        private static GenType do_deduceIdentExpression__VAR(
                final DeduceTypes2 aDeduceTypes2,
                final Context ctx,
                final @Nullable GenType R,
                final @Nullable VariableStatement vs)
                throws ResolveError {
            ...
            if (!vs.typeName().isNull()) {
                ...
                @NotNull
                final Promise<GenType, ResolveError, Void> x =
                        aDeduceTypes2.resolve_type_p(lets_hope_we_dont_need_this, new OS_UserType(vs.typeName()), ctx);
                ...
                final Promise<GenType, ResolveError, Void> x2 =
                        deduceExpression_p(aDeduceTypes2, vs.initialValue(), vs.getContext());
        ...
        @NotNull
        private static GenType do_deduceIdentExpression__FUNCTION(
                final @NotNull GenType R, final @Nullable FunctionDef functionDef) {
            R.setResolved(functionDef.getOS_Type());
            return R;
        }

        @NotNull
        private static GenType do_deduceIdentExpression__fali(
                final DeduceTypes2 aDeduceTypes2,
                final Context ctx,
                final @NotNull GenType R,
                final @Nullable FormalArgListItem fali)
                throws ResolveError {
            GenType result = null;
            ...
            if (!fali.typeName().isNull()) {
                ...
                @NotNull
                final GenType ty =
                        aDeduceTypes2.resolve_type(lets_hope_we_dont_need_this, new OS_UserType(fali.typeName()), ctx);
                result = ty;
                if (result == null) {
        ...
        public void do_deduceIdentExpression(
                final DeduceTypes2 aDeduceTypes2, final IdentExpression ident, final Context ctx) {
            try {
    ...
    /*
     * @Contract("_, _ -> param1") public static @NotNull
     * DeduceElement3_IdentTableEntry deduceExpression2(final @NotNull
     * DeduceElement3_IdentTableEntry de3_ite, final FunctionContext aFc) { final
     * IdentExpression identExpression = de3_ite.principal.getIdent(); final
     * IdentTableEntry ite = new IdentTableEntry(0, identExpression,
     * identExpression.getContext()); final DeduceElementIdent dei = new
     * DeduceElementIdent(ite);
     *
     * try { deduceIdentExpression2(de3_ite); } catch (final ResolveError aE) {
    ...
    /*
     * private static void deduceIdentExpression2(final @NotNull
     * DeduceElement3_IdentTableEntry ident1) throws ResolveError {
     *
     * @Nullable GenType result = null;
     *
     * @Nullable GenType R = ident1.genType();
     *
     * final @NotNull DeduceTypes2 dt2 = ident1.deduceTypes2(); //assert dt2 ==
     * aDeduceTypes2;
     *
     * final @NotNull IdentExpression ident = ident1.principal.getIdent(); final
     * Context ctx = ident.getContext();
     *
     * // is this right? final LookupResultList lrl = ctx.lookup(ident.getText());
     *
     * @Nullable OS_Element best = lrl.chooseBest(null); while (best instanceof
     * AliasStatement) { best = _resolveAlias2((AliasStatement) best, dt2); } if
     * (best instanceof ClassStatement) { R.resolved = ((ClassStatement)
     * best).getOS_Type(); result = R; } else { switch
     * (DecideElObjectType.getElObjectType(best)) { case VAR: final @Nullable
     * VariableStatement vs = (VariableStatement) best; if (!vs.typeName().isNull())
     * { try {
     *
     * @Nullable final OS_Module lets_hope_we_dont_need_this = null;
     *
     * @NotNull final GenType ty = dt2.resolve_type(lets_hope_we_dont_need_this, new
     * OS_Type(vs.typeName()), ctx); result = ty; } catch (final ResolveError
     * aResolveError) { // TODO This is the cheap way to do it // Ideally, we would
     * propagate this up the call chain all the way to lookupExpression
     * aResolveError.printStackTrace(); } if (result == null) { R.typeName = new
     * OS_Type(vs.typeName()); result = R; } } else if (vs.initialValue() ==
     * IExpression.UNASSIGNED) { R.typeName = new OS_UnknownType(vs); // return
     * deduceExpression(vs.initialValue(), ctx); // infinite recursion } else {
     * final @NotNull IExpression initialValue = vs.initialValue(); if
     * (initialValue.getKind() == ExpressionKind.PROCEDURE_CALL) { final Context
     * vsContext = vs.getContext(); final ProcedureCallExpression pce =
     * (ProcedureCallExpression) initialValue; R = deduceExpression(dt2, pce,
     * vsContext); } else { R = deduceExpression(dt2, initialValue,
     * vs.getContext()); } } if (result == null) { result = R; } break; case
     * FUNCTION: final @NotNull FunctionDef functionDef = (FunctionDef) best;
     * R.resolved = functionDef.getOS_Type(); result = R; break; case
     * FORMAL_ARG_LIST_ITEM: final @NotNull FormalArgListItem fali =
     * (FormalArgListItem) best; if (!fali.typeName().isNull()) { try {
     *
     * @Nullable final OS_Module lets_hope_we_dont_need_this = null;
     *
     * @NotNull final GenType ty = dt2.resolve_type(lets_hope_we_dont_need_this, new
     * OS_Type(fali.typeName()), ctx); result = ty; } catch (final ResolveError
     * aResolveError) { // TODO This is the cheap way to do it // Ideally, we would
     * propagate this up the call chain all the way to lookupExpression
     * aResolveError.printStackTrace(); } if (result == null) { R.typeName = new
     * OS_Type(fali.typeName()); } } else { R.typeName = new OS_UnknownType(fali); }
     * if (result == null) { result = R; } break; } if (result == null) { throw new
     * ResolveError(ident, lrl); } } }
     */
}
