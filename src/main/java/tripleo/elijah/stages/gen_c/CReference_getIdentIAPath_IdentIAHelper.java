...
class CReference_getIdentIAPath_IdentIAHelper {
    ...
    CReference_getIdentIAPath_IdentIAHelper(
    ...
    boolean action(final CRI_Ident aCRI_ident, final CReference aCReference) {
        ...
        if (resolvedElement instanceof ClassStatement) {
            ...
            SimplePrintLoggerToRemoveSoon.println_out(
                    "1008 " + resolvedElement.getClass().getName());
    ...
    private void _act_VariableStatement(final CReference aCReference) {
        ...
        final VariableSequence variableSequence =
                (VariableSequence) getResolved_element().getParent();
    ...
    private void _act_PropertyStatement(final CReference aCReference) {
        ...
        final String text2 =
                String.format("ZP%dget_%s", code, ((PropertyStatement) getResolved_element()).name()); // TODO
        // Don't
        // know
        // if
        // get
