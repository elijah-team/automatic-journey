            ...
            public void annotation(final AnnotationPart anno) {
                if (anno.annoClass().equals(Helpers.string_to_qualident("C.repr"))) {
                    if (anno.getExprs() != null) {
                        final ArrayList<IExpression> expressions =
                                new ArrayList<IExpression>(anno.getExprs().expressions());
                ...
                if (anno.annoClass().equals(Helpers.string_to_qualident("Primitive"))) setPrimitive();
            }
        });
    }
