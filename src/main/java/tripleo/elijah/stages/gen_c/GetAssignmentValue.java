...
class GetAssignmentValue {
    ...
    static String const_to_string(final IExpression expression) {
...
//					assert false; // TODO synthetic methods
    ...
    @NotNull
    List<String> getAssignmentValueArgs(final @NotNull Instruction inst, final BaseGeneratedFunction gf,
                                        final ElLog LOG) {
