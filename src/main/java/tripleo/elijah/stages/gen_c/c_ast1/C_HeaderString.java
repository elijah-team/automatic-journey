...
public class C_HeaderString {
	...
	public static @NotNull C_HeaderString forClass(final GeneratedClass aGeneratedClass,
			...
			final @NotNull String args_string, final ElLog LOG) {
...
//		assert args_string.length() == 0;
	...
	public static @NotNull C_HeaderString forOther(final GeneratedContainerNC aParent, final String return_type,
