...
public class C_HeaderString {
    ...
    public static @NotNull C_HeaderString forClass(
            final GeneratedClass aGeneratedClass,
        ...
        final String result = String.format(
                "%s %s%s(%s* vsc%s%s)", return_type, class_name0, name, class_name0, if_args, args_string);
        return new C_HeaderString(result);
    }

    @Contract("_, _, _, _, _, _ -> new")
    public static @NotNull C_HeaderString forNamespace(
            final @NotNull GeneratedNamespace st,
    ...
    public static @NotNull C_HeaderString forOther(
            final GeneratedContainerNC aParent, final String return_type, final String name, final String args_string) {
