...
public class IdentTableEntry extends BaseTableEntry1
    ...
    protected final DeferredObject<InstructionArgument, Void, Void> backlinkSet =
            new DeferredObject<InstructionArgument, Void, Void>();
    ...
    public OS_Element getResolvedElement() {
        // short circuit
        if (resolved_element != null) return resolved_element;
    ...
    public DeducePath buildDeducePath(final BaseGeneratedFunction generatedFunction) {
        @NotNull
        final List<InstructionArgument> x =
    ...
    public void fefiDone(final GenType aGenType) {
        if (fefiDone.isPending()) fefiDone.resolve(aGenType);
    }
