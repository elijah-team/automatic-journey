        ...
        switch (aAttached.getType()) {
            case USER:
                if (genType.getTypeName() != null) {
                    ...
                    if (!(typeName instanceof GenericTypeName)) genType.setNonGenericTypeName(typeName);
                } else genType.setTypeName(aAttached) /* .getTypeName() */;
                break;
            case USER_CLASS:
            ...
            case BUILT_IN:
                if (genType.getTypeName() != null) genType.setResolved(aAttached);
                else genType.setTypeName(aAttached);
                break;
            case FUNCTION:
                assert genType.getResolved() == null
                        || genType.getResolved() == aAttached
                        || /* HACK */ aAttached.getType() == OS_Type.Type.FUNCTION;
                genType.setResolved(aAttached);
                break;
            case FUNC_EXPR:
                assert genType.getResolved() == null
                        || genType.getResolved() == aAttached; // || /*HACK*/ aAttached.getType() ==
