...
public class GenType {
    ...
    public boolean equals(final Object aO) {
        ...
        if (!Objects.equals(getResolvedn(), genType.getResolvedn())) return false;
        if (!Objects.equals(getTypeName(), genType.getTypeName())) return false;
        if (!Objects.equals(getNonGenericTypeName(), genType.getNonGenericTypeName())) return false;
        if (!Objects.equals(getResolved(), genType.getResolved())) return false;
        if (!Objects.equals(getCi(), genType.getCi())) return false;
        if (!Objects.equals(getNode(), genType.getNode())) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result
                + (getNonGenericTypeName() != null ? getNonGenericTypeName().hashCode() : 0);
        ...
        result = 31 * result
                + (getFunctionInvocation() != null ? getFunctionInvocation().hashCode() : 0);
        return result;
    }

    public String asString() {
        final String sb = "GenType{" + "resolvedn=" + getResolvedn() + ", typeName=" + getTypeName()
                + ", nonGenericTypeName="
    ...
    public boolean isNull() {
        if (getResolvedn() != null) return false;
        if (getTypeName() != null) return false;
        if (getNonGenericTypeName() != null) return false;
        if (getResolved() != null) return false;
        if (getCi() != null) return false;
        return getNode() == null;
    }

    public void copy(final GenType aGenType) {
        if (getResolvedn() == null) setResolvedn(aGenType.getResolvedn());
        if (getTypeName() == null) setTypeName(aGenType.getTypeName());
        if (getNonGenericTypeName() == null) setNonGenericTypeName(aGenType.getNonGenericTypeName());
        if (getResolved() == null) setResolved(aGenType.getResolved());
        if (getCi() == null) setCi(aGenType.getCi());
        if (getNode() == null) setNode(aGenType.getNode());
    }
    ...
    static class SetGenCI {
        ...
        public ClassInvocation call(
                @NotNull final GenType genType,
                final TypeName aGenericTypeName,
            ...
            if (genType.getResolved() != null) {
                ...
                switch (type) {
                    case USER_CLASS -> {
                        return ((OS_UserClassType) genType.getResolved())
                                .resolvedUserClass(genType, aGenericTypeName, deduceTypes2.dcc());
                    }
                    case FUNCTION -> {
                        return ((OS_FuncType) genType.getResolved())
                                .resolvedFunction(genType, aGenericTypeName, deduceTypes2, errSink, phase);
                    }
                    case FUNC_EXPR -> {
        ...
        private @NotNull ClassInvocation nonGenericTypeName(
            ...
            switch (genType.getResolved().getType()) {
                ...
                case USER_CLASS:
                    ...
                    //
                    ClassInvocation clsinv2 =
                            ClassInvocationMake.withGenericPart(best, constructorName, aTyn1, deduceTypes2.dcc());
                    clsinv2 = phase.registerClassInvocation(clsinv2);
                    genType.setCi(clsinv2);
                    return clsinv2;
                default:
                    throw new IllegalStateException(
                            "Unexpected value: " + genType.getResolved().getType());
            }
        }
    }
}
