...
public class EDR_CompilationRunner implements ICompilationRunner {
    ...
    private @NotNull Operation<CompilerInstructions> findStdLib(
            final String prelude_name, final @NotNull Compilation c) {
    ...
    public class CR_FindCIs implements CR_Action {
        ...
        public void execute(final CR_State st) {
            ...
            final IProgressSink ps = new IProgressSink() {
                @Override
                public void note(
                        final int aCode, final ProgressSinkComponent aCci, final int aType, final Object[] aParams) {}
            };
    ...
    private class CR_FindStdlibAction implements CR_Action {
        ...
        @Override
        public void execute(final CR_State st) {
            final Operation<CompilerInstructions> oci = findStdLib(CompilationAlways.defaultPrelude(), compilation);
            switch (oci.mode()) {
