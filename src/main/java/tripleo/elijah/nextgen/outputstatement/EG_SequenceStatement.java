...
public class EG_SequenceStatement implements EG_Statement {
    ...
    public EG_SequenceStatement(
            final EG_Naming aNaming,
            final String aNewBeginning,
            final String aNewEnding,
    ...
    public String getText() {
        final String ltext =
                Helpers.String_join(" ", list.stream().map(st -> st.getText()).collect(Collectors.toList()));
        if (beginning != null) {
