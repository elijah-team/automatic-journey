...
public class MethHdrNode implements Node {
    ...
    public final MethNameNode methName;
    ...
    public MethHdrNode(
            final Node parent,
            @NonNull final IdentExpression return_type,
            final String method_name,
            final List<ArgumentNode> argument_types,
            final int code) {
        _parent = parent;
        _code = code;
    ...
    public MethHdrNode(
            final TypeRef retType,
            final Node parent,
            final String methodName,
            final List<ArgumentNode> argumentTypes,
            final int code) {
        _parent = parent;
        _code = code;
