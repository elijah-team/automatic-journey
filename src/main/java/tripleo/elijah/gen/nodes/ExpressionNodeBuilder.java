...
public class ExpressionNodeBuilder {
    ...
    public static IExpression binex(
            final TypeRef rt, final VariableReference left, final ExpressionOperators middle, final IExpression right) {
    ...
    public static IExpression binex(
            final TypeRef rt,
            final VariableReference left,
            final ExpressionOperators middle,
    ...
    @NotNull
    public static IExpressionNode binex(
            final TypeRef rt,
            final VariableReferenceNode3 n,
            final ExpressionOperators opMinus,
            final NumericExpression integer) {
    ...
    public static IExpressionNode binex(
            final TypeRef rt,
            final VariableReferenceNode3 varref,
            final ExpressionOperators operators,
            final TmpSSACtxNode node) {
    ...
    private static class MyIExpressionNode1 implements IExpressionNode {
        ...
        public MyIExpressionNode1(
                final VariableReferenceNode3 left, final ExpressionOperators middle, final IExpressionNode right) {
            _left = left;
            _middle = middle;
            _right = right;
        }
