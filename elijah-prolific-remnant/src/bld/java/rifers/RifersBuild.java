...
public class RifersBuild extends WebProject {
	public RifersBuild() {
		...
		//final String V_jcef = "122.1.10";
		final String V_jcef = "jcef-0b8e42e+cef-122.1.10+gc902316+chromium-122.0.6261.112";
...
//				.include(dependency("commons-cli", "commons-cli", "1.8.0"))
		...
		var mal_directory      = new File(workDirectory(), "src-mal");
	...
	public static void main(String[] args) {
		final RifersBuild build = new RifersBuild();
		build.start(args);
