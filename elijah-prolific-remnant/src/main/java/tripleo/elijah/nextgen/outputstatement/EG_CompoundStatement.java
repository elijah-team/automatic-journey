...
public class EG_CompoundStatement implements EG_Statement {
	...
	public EG_CompoundStatement(final @NotNull EG_SingleStatement aBeginning, final @NotNull EG_SingleStatement aEnding,
			final @NotNull EG_Statement aMiddle, final boolean aIndent, final @NotNull EX_Explanation aExplanation) {
