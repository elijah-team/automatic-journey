	...
	public static class ST {
		...
		static class ExitGetType implements State {
			...
			public void assign_type_to_idte(@NotNull final IdentTableEntry ite,
					@NotNull final BaseGeneratedFunction generatedFunction, @NotNull final Context aFunctionContext,
					@NotNull final Context aContext, @NotNull final DeduceTypes2 dt2,
						...
						public void foundElement(final OS_Element x) {
							...
							if (ite.type != null && ite.type.getAttached() != null) {
								...
								case USER:
									try {
										@NotNull
										final GenType xx = dt2.resolve_type(ite.type.getAttached(), aFunctionContext);
								...
								default:
									throw new IllegalStateException(
											"Unexpected value: " + ite.type.getAttached().getType());
								}
							} else {
								final int yy = 2;
								if (!ite.hasResolvedElement()) {
...
//												continue;
						...
						private void use_user_class(@NotNull final OS_Type aType,
								@NotNull final IdentTableEntry aEntry) {
